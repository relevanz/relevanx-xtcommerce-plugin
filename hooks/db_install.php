...
$rc = $db->Execute("SELECT * FROM ".TABLE_ADMIN_NAVIGATION." WHERE text = 'tfm_releva_nz' ");
if ($rc->RecordCount()==0){
    $db->Execute("INSERT INTO `".TABLE_ADMIN_NAVIGATION."` ( `text`, `icon`, `url_i`, `url_d`, `sortorder`, `parent`, `type`, `navtype`, `cls`, `handler`, `iconCls`) VALUES ('tfm_releva_nz', '../plugins/tfm_releva_nz/images/relevanz.png', '../index.php?page=tfm_releva_nz&seckey="._SYSTEM_SECURITY_KEY."', '', 10000, 'config', 'I', 'W', NULL, 'clickHandler2', NULL);");
}
...
( \''.$hash.'\', \'de\', 1, \'releva.nz - Export\', 1, \'"products_id\";\"products_name\";\"products_ean\";\"products_mode\";\"products_cat_id\";\"products_cat_name\";\"manufacturers_id\";\"manufcaturers_name\";\"\";\"products_desc_short\";\"products_desc_long\";\"products_price\";\"products_deeplink\";\"products_1st_image\"\', \'"{$data.products_id}\";\"{$data.products_name}\";\"{$data.products_ean}\";\"{$data.products_model}\";\"{$data.tfm_category_id}\";\"{$data.category}\";\"m_{$data.manufacturers_id}\";\"{$data.manufacturers_name}\";\"{$data.products_short_description_clean}\";\"{$data.products_description_clean}\";\"{$data.products_price.plain}\";\"{$data.products_link}\";\"{$data.products_image_popup}\"\', \'\', \'\', 0, \'\', \'\', 0, \'\', \'\', \'\', \'\', 0, \'releva_nz\', \'.csv\', \'UTF-8\', 1, 300, 0, \'EUR\', 0, \'\', \'\', \'\', \'\', \'\', \'\', \'\', 0, \'\', \'\', 0, 0, 0, NULL, NULL, 0, \'\', \'\', 0, \'\', \'\', 0);');
